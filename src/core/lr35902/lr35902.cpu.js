...
export default class LR35902 {
  ...
  set A(value) { this.r8[0] = value }
  set B(value) { this.r8[1] = value }
  set C(value) { this.r8[2] = value }
  set D(value) { this.r8[3] = value }
  set E(value) { this.r8[4] = value }
  set H(value) { this.r8[5] = value }
  set L(value) { this.r8[6] = value }
  /**
   * F can't be set via set F(),
   * but we can set the flags individually
   */
  get F() { this.F = this.z << 7 | this.n << 6 | this.h << 5 | this.c << 4; }
  /**
   ...
   */
  _get(registers) {
    this.r16[0] = (this[registers[0]] & 0xff) << 8 | (this[registers[1]] & 0xff);
    return this.r16[0];
  }
